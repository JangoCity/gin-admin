...
// QueryPage 查询分页数据
func (a *Menu) QueryPage(ctx context.Context, params schema.MenuQueryParam, pp *gschema.PaginationParam) ([]*schema.Menu, *gschema.PaginationResult, error) {
...
func (a *Menu) Delete(ctx context.Context, recordID string) error {
	result, err := a.MenuModel.Query(ctx, schema.MenuQueryParam{
		ParentID: &recordID,
	}, schema.MenuQueryOptions{PageParam: &gschema.PaginationParam{PageSize: -1}})
	if err != nil {
		return err
